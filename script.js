const MENU_ITEMS = [
  { id: 1, name: "Idly", price: 30, category: "Breakfast", prep: "Fast" },
  { id: 2, name: "Masala Dosa", price: 55, category: "Breakfast", prep: "Fresh Tawa" },
  { id: 3, name: "Veg fried rice", price: 120, category: "Lunch", prep: "Popular" },
  ...
  { id:12, name: "egg parotta", price: 40, category: "Breakfast", prep: "fast" },
  { id:13, name: "bajji", price: 20, category: "Snacks", prep: "quick" },
  { id:14, name: "chapati", price: 15, category: "Lunch", prep: "popular" },
  { id:15, name: "egg chapati", price: 25, category: "Lunch", prep: "popular" },
  { id:16, name: "Rava Dosa", price: 60, category: "Breakfast", prep: "Fresh Tawa" },
  { id:17, name: "uttapam", price: 50, category: "Breakfast", prep: "Fresh Tawa" },
  { id:18, name: "upma", price: 35, category: "Breakfast", prep: "Fast" },
  { id:19, name: "sambar idly", price: 50, category: "Breakfast", prep: "Fast" },
  { id:20, name: "onion Dosa", price: 65, category: "Breakfast", prep: "Fresh Tawa" },
  { id:21, name: "plain dosa", price: 50, category: "Breakfast", prep: "Fresh Tawa" },
];
