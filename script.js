const MENU_ITEMS = [
  { id: 1, name: "Idly", price: 20, category: "Breakfast", prep: "Fast" },
  { id: 2, name: "Masala Dosa", price: 40, category: "Breakfast", prep: "Fresh Tawa" },
  { id: 3, name: "Veg fried rice", price: 60, category: "Lunch", prep: "Popular" },
  { id: 4, name: "Punugu", price: 25, category: "Snacks", prep: "Quick" },
  { id: 5, name: "Tea (Parcel)", price: 15, category: "Beverage", prep: "2 min" },
  { id: 6, name: "Coffee (Parcel)", price: 20, category: "Beverage", prep: "2 min" },
  { id: 7, name: "Veg Noodles", price: 60, category: "Noodles", prep: "Hot & Tasty" },
  { id: 8, name: "Chicken Noodles", price: 80, category: "Noodles", prep: "Hot & Tasty" },
  { id:9, name: "chicken fried rice", price: 80, category: "Lunch", prep: "popular" },
  { id:10, name: "Egg Dosa", price: 40, category: "Breakfast", prep: "Fresh Tawa" },
  { id:11, name: "parotta", price: 35, category: "Breakfast", prep: "fast" },
  { id:12, name: "egg parotta", price: 45, category: "Breakfast", prep: "fast" },
  { id:13, name: "bajji", price: 25, category: "Snacks", prep: "quick" },
  { id:14, name: "chapati", price: 35, category: "Lunch", prep: "popular" },
  { id:15, name: "egg chapati", price: 45, category: "Lunch", prep: "popular" },
  { id:16, name: "Rava Dosa", price: 35, category: "Breakfast", prep: "Fresh Tawa" },
  { id:18, name: "upma", price: 20, category: "Breakfast", prep: "Fast" },
  { id:19, name: "sambar idly", price: 40, category: "Breakfast", prep: "Fast" },
  { id:20, name: "onion Dosa", price: 35, category: "Breakfast", prep: "Fresh Tawa" },
  { id:21, name: "plain dosa", price: 30, category: "Breakfast", prep: "Fresh Tawa" },
  { id:22, name: "Gari", price: 25, category: "Snacks", prep: "Quick" },
  { id:23, name: "Puri", price: 30, category: "Breakfast", prep: "Fast" },
  { id:24, name: "Chicken Biryani", price: 150, category: "Lunch", prep: "Special" },
  { id:25, name: "Pesarattu", price: 35, category: "Breakfast", prep: "Fresh Tawa" },
  { id:26, name: "Sambar Gari", price:40, category: "Snacks", prep: "Quick" },
  { id:27, name: "Upma Pesarattu", price: 45, category: "Breakfast", prep: "Fresh Tawa" },
  { id:28, name: "Egg Fried Rice", price: 70, category: "Lunch", prep: "Popular" },
  { id:29, name: "Roast Fried Rice", price: 120, category: "Lunch", prep: "Popular" },
  { id:30, name: "Egg Noodles", price: 70, category: "Noodles", prep: "Hot & Tasty" },
  { id:31, name: "Omelette", price: 20, category: "Breakfast", prep: "Fast" },
  { id:32, name: "Meals", price: 70, category: "Lunch", prep: "Special" },
  { id:33, name: "Veg Curry", price: 25, category: "Lunch", prep: "Popular" },
  { id:34, name: "Chicken Curry", price: 70, category: "Lunch", prep: "Popular" },
  { id:35, name: "Horlicks (Parcel)", price: 25, category: "Beverage", prep: "2 min" },
  { id:36, name: "Boost (Parcel)", price: 25, category: "Beverage", prep: "2 min" },
];
